...
import { useDashboardAuth } from "./shared/hooks";

const navItems = [
  { label: "Dashboard", href: "/dashboard", icon: LayoutDashboard, locked: false },
  { label: "Profile Refactor", href: "/dashboard/refactor", icon: Sparkles, locked: false },
  { label: "Voice & Intent", href: "/dashboard/voice", icon: Mic, locked: false },
  { label: "Create Post", href: "/dashboard/posts", icon: FileText, locked: false },
  { label: "Insights", href: "/dashboard/insights", icon: Lightbulb, locked: false },
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-100">
          {!isCollapsed && <span className="text-xl font-semibold text-gray-900">OLIS</span>}
          <Button
            variant="ghost"
            size="icon"
              ...
              >
                ...
                {!isCollapsed && (
                  <>
                    ...
                    {item.locked && <Lock className="h-3.5 w-3.5 text-gray-400" />}
                  </>
                )}
              </button>
            );
